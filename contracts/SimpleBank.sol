...
contract SimpleBank {
    ...
    modifier isEnrolled() {
        require(enrolled[msg.sender], 'Address is not enrolled to the bank');
        _;
    }

    modifier isNotEnrolled() {
        require(!enrolled[msg.sender], 'Address is already enrolled to the bank');
        _;
    }
    //
    // Functions
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
        /* If the sender's balance is at least the amount they want to withdraw,
           ...
           require(balances[msg.sender] >= withdrawAmount, 'Balance is insufficient');
